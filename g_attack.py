...
if len(sys.argv) < 2:
    ...
    ╚██████╔╝      ██║  ██║   ██║      ██║   ██║  ██║╚██████╗██║  ██╗
     ╚═════╝       ╚═╝  ╚═╝   ╚═╝      ╚═╝   ╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝
                ...
                MADE_BY : TEM BANGLADESH {we are AnOnYmouSe}

                                                                                          
    """  + END+BLUE+'G-ATTACK'.format(RED, END).center(69) +
    '\n' + '\tAUTHOR: GM_HACX'.format(YELLOW, RED, YELLOW, BLUE).center(76) +
    '\n' + '\tVersion: {}1.0{}\n'.format(YELLOW, END).center(80) + '\n')
else:
    sys.exit('Usage: python g-Bomp.py')
    os.system("clear || cls")
